...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spinBoxMaxSpx->setObjectName(QStringLiteral("spinBoxMaxSpx"));
        ...
        spinBoxMaxWeight->setObjectName(QStringLiteral("spinBoxMaxWeight"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Fast Hierarchy", Q_NULLPTR));
